...
### デプロイ先
 http://35.76.243.118/
### ログイン情報
Eメール: kaigo1@i, パスワード: kaigo11
# 制作背景
サービスを開発するにあたり、実際に身近な人が不便だと感じること、社会問題を解決するアプリを作成しようと考え、実際に友人や家族にヒヤリングを行いました。
その中で、私の母親と妹が介護関係の仕事をしており、仕事の業務内容を聞いたり、家で実際に作業しているところ見ると、業務内容にアナログな作業が多くありました。自分が業務内容をより楽に、効率化ができるものを作ることにより、母や妹、社会問題である少子高齢化による介護業界での業務内容向上を図ることができると考え、今回のアプリを制作しました。
# DEMO
## トップページ
...
#### ・各機能の説明をトップページに表示→実際にアプリでできることを把握できるようにした
## ユーザー新規登録機能
...
#### ・全ての項目が入力されていないと登録できないように設定
#### ・同じEメールアドレスを入力すると登録できないように設定
## ルーム作成機能
